(function (global, factory) {
  ...
  var previousPaddedElements = void 0;
      ...
      if (previousBodyPaddingRight === undefined) {
        ...
        if (_reserveScrollBarGap && scrollBarGap > 0) {
          ...
          if (options.paddedElements) {
            ...
            options.paddedElements.forEach(function (el) {
  ...
  var restoreOverflowSetting = function restoreOverflowSetting() {
    ...
    setTimeout(function () {
      ...
      if (Array.isArray(previousPaddedElements)) {
        previousPaddedElements.forEach(function (el) {
  ...
  var isScrollLockActive = exports.isScrollLockActive = function isScrollLockActive() {
    return scrollLockActive;
  };

  var setDefaultOptions = exports.setDefaultOptions = function setDefaultOptions(options) {
